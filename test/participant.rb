...
module ParticipantUnitTests
  ...
  Fixtures = [ 
    ...
    { :desc    => 'email has subject and body, offset specified, one set of availability',
    ...
    { :desc    => 'email has subject and body, offset specified, two sets of available dates',
      :from    => 'raj@boom.com',
    ...
    { :desc    => 'email has subject and body, offset specified, three sets of available times',
    ...
    { :desc    => 'email has subject and body, offset specified, multiple sets of availability',
      :from    => 'tiger@golf.com',
      ...
      :expected_availables => [
        {:days => [1,3,5], :from => '1:00pm', :to => '2:00pm',  :utc_offset => '+00:00'},
        {:days => [1,3,5], :from => '3:30pm', :to => '4:30pm',  :utc_offset => '+00:00'},
        {:days => [1,3,5], :from => '8:20pm', :to => '10:30pm', :utc_offset => '+00:00'},
        {:days => [2,6],   :from => '10:00',  :to => '15:15',   :utc_offset => '+00:00'},
        {:days => [2,6],   :from => '17:15',  :to => '19:30',   :utc_offset => '+00:00'}        
      ]
    },

    { :desc    => 'email has no offset specified, one set of availability',
      :from    => 'uuu@uuvoo.com',
      :display_name => 'Ultra',
      :date    => Time.parse("Sun Mar 11 14:13 UTC 2012"),
      :subject => '12-Mar-2012',
      :body    => ['Mon Wed Fri', 
                   '12:30pm - 20:00'].join("\r\n"),
      :defaults => {},
      :expected_name   => 'Ultra',
      :expected_email  => 'uuu@uuvoo.com',
      :expected_availables => [
        {:days => [1,3,5], :from => '12:30pm', :to => '20:00', :utc_offset => 0}
      ]
    },
    
    { :desc    => 'email has no offset specified, multiple sets of availability',
      :from    => 'vladmir@velociraptor.com',
      :display_name => 'V.I.P.',
      :date    => Time.parse("Sun Mar 11 14:13 UTC 2012"),
      :subject => ' 12-Mar-2012',
      :body    => ['  ',
      ...
      :defaults => {},
      :expected_name   => 'V.I.P.',
      :expected_email  => 'vladmir@velociraptor.com',
      :expected_availables => [
        {:days => [1,3,5], :from => '1:00pm', :to => '2:00pm',  :utc_offset => 0},
        {:days => [1,3,5], :from => '3:30pm', :to => '4:30pm',  :utc_offset => 0},
        {:days => [1,3,5], :from => '8:20pm', :to => '10:30pm', :utc_offset => 0},
        {:days => [2,6],   :from => '10:00',  :to => '15:15',   :utc_offset => 0},
        {:days => [2,6],   :from => '17:15',  :to => '19:30',   :utc_offset => 0}        
      ]
    }
  ...
  Fixtures.each do |fixture|
    describe "Participant.from_email, #{fixture[:desc]}" do
      ...
      it 'should be valid' do
        assert @subject.valid?, "Participant not valid, errors:\n" + 
                                @subject.errors.join("\n")
      end
